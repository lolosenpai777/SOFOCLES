      ...
      setPosts((postsActuales) =>
        postsActuales.map((post) => {
          ...
          if (idActual === postId) {
            ...
            if (postActualizado && (postActualizado.likes || postActualizado.megustas)) {
                    ...
                    <article key={post._id || post.id} className="Card-Post Modal-Animacion">
                      ...
                      <div className="Cuerpo-Post-Contenido">
                        ...
                        <button
                          ...
                          onClick={() => console.log('Like post', post._id || post.id)}
                          aria-label="Me gusta"
                        >
                          <svg className="Icono-Like" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
